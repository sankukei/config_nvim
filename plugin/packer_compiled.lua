...
local package_path_str = "/mnt/nfs/homes/leothoma/.cache/nvim/packer_hererocks/2.1.1713484068/share/lua/5.1/?.lua;/mnt/nfs/homes/leothoma/.cache/nvim/packer_hererocks/2.1.1713484068/share/lua/5.1/?/init.lua;/mnt/nfs/homes/leothoma/.cache/nvim/packer_hererocks/2.1.1713484068/lib/luarocks/rocks-5.1/?.lua;/mnt/nfs/homes/leothoma/.cache/nvim/packer_hererocks/2.1.1713484068/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/mnt/nfs/homes/leothoma/.cache/nvim/packer_hererocks/2.1.1713484068/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ale = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/ale",
    url = "https://github.com/w0rp/ale"
  },
  ["colorbuddy.vim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/colorbuddy.vim",
  ...
  ["completion-nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/completion-nvim",
    url = "https://github.com/haorenW1025/completion-nvim"
  },
  dracula = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/dracula",
    url = "https://github.com/dracula/vim"
  },
  firenvim = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/firenvim",
    url = "https://github.com/glacambre/firenvim"
  },
  ["flow.nvim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/flow.nvim",
    url = "https://github.com/0xstepit/flow.nvim"
  },
  ["gitsigns.nvim"] = {
    config = { "\27LJ\2\n6\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\rgitsigns\frequire\0" },
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
    url = "https://github.com/lewis6991/gitsigns.nvim"
  },
  ["jellybeans.vim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/jellybeans.vim",
  ...
  ["markdown-preview.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim",
    url = "https://github.com/iamcco/markdown-preview.nvim"
  },
  ["mason.nvim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/mason.nvim",
    url = "https://github.com/williamboman/mason.nvim"
  },
  ["nvim-treesitter"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/nvim-treesitter",
    url = "https://github.com/nvim-treesitter/nvim-treesitter"
  },
  ["packer.nvim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/packer.nvim",
    url = "https://github.com/wbthomason/packer.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/plenary.nvim",
    url = "https://github.com/nvim-lua/plenary.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/telescope.nvim",
    url = "https://github.com/nvim-telescope/telescope.nvim"
  },
  ["vim-closer"] = {
    loaded = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/start/vim-closer",
  ...
  ["vim-dispatch"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/vim-dispatch",
    url = "https://github.com/tpope/vim-dispatch"
  },
  ["vim-matchup"] = {
    after_files = { "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/vim-matchup/after/plugin/matchit.vim" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/vim-matchup",
  ...
  ["vim-vsnip"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/vim-vsnip",
    url = "https://github.com/hrsh7th/vim-vsnip"
  },
  ["vim-vsnip-integ"] = {
    after_files = { "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/vim-vsnip-integ/after/plugin/vsnip_integ.vim" },
    load_after = {
      ["completion-nvim"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/mnt/nfs/homes/leothoma/.local/share/nvim/site/pack/packer/opt/vim-vsnip-integ",
